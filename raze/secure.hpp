...
public:
	...
	vote (raze::account const &, raze::raw_key const &, uint64_t, std::shared_ptr<raze::block>, raze::block_hash const &);
	vote (MDB_val const &);
...
public:
	...
	raze::block_hash hash2_calc (MDB_txn *, raze::block const &);
	raze::block_hash hash2_get (MDB_txn *, raze::block_hash const &);
	void hash2_put (MDB_txn *, raze::block_hash const &, raze::block_hash const &);
	void hash2_del (MDB_txn *, raze::block_hash const &);
	...
	std::pair<std::shared_ptr<raze::vote>, std::shared_ptr<raze::vote>> vote_generate (MDB_txn *, raze::account const &, raze::raw_key const &, std::shared_ptr<raze::block>);
